...
def on_save_to_library_click(e: me.ClickEvent):
    ...
    try:
        ...
        filename = f"worsfold-encoder-gif-{uuid.uuid4()}.gif"
        ...
        add_media_item_to_firestore(
            MediaItem(
                ...
                prompt="a GIF generated by the Worsfold Encoder",
                mime_type="image/gif",
                user_email=app_state.user_email,
                source_images_gcs=[state.selected_video_gcs_uri],
                comment="Generated by Worsfold Encoder",
                model="ffmpeg-worsfold-encoder",
            )
        )
