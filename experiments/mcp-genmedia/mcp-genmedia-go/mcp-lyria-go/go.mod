...
require (
	cloud.google.com/go/aiplatform v1.98.0
	github.com/GoogleCloudPlatform/vertex-ai-creative-studio/experiments/mcp-genmedia/mcp-genmedia-go/mcp-common v0.0.0-20250811050616-2433a9f913ef
