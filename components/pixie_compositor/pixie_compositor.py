...
"""Python wrapper for the Pixie Compositor Lit component."""

import mesop as me
import typing

@me.web_component(path="./pixie_compositor.js")
def pixie_compositor(
    *,
    # --- Properties ---
    video_url: str = "",
    config: dict = {},
    ...
    """Defines the API for the Pixie Compositor web component."""
    return me.insert_web_component(
        key=key,
        name="pixie-compositor",
        properties={
            "videoUrl": video_url,
            "config": config,
