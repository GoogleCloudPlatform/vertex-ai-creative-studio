...
from common.utils import gcs_uri_to_https_url, https_url_to_gcs_uri, proxy_url_to_gcs_uri
...
def on_transformation_click(e: me.ClickEvent):
    ...
    input_gcs_uri = proxy_url_to_gcs_uri(state.selected_image_url)
...
def on_suggest_transformations_click(e: me.ClickEvent):
    ...
    try:
        ...
        gcs_uri = proxy_url_to_gcs_uri(state.generated_image_urls[0])
...
def on_image_action_click(e: me.ClickEvent):
    ...
    if state.selected_image_url:
        user_image_uri = proxy_url_to_gcs_uri(state.selected_image_url)
...
def on_continue_click(e: me.ClickEvent):
    ...
    gcs_uri = proxy_url_to_gcs_uri(state.selected_image_url)
